...
// */
//public class FullyGrindingMill_old {
...
//    }
//
//    public GroundMLN handleEvidence(GroundMLN groundMln, Evidence evidence, Evidence truth, List<String> evidence_preds, List<String> query_preds, List<String> hidden_preds, boolean withEM, Map<GroundPredicate,Integer> newGpToIntegerMap) throws CloneNotSupportedException {
...
//        List<GroundPredicate> newGpList = new ArrayList<>();                                        //new groundMLN.groundPredicates
//
//        if(newGpToIntegerMap == null){
//            newGpToIntegerMap = new HashMap<GroundPredicate,Integer>();
//        }
//
////        int formulaNum = 0;
...
//            }
//        }
//        newGroundMln.sePredCount = count;
//        return newGroundMln;
//    }
...
//    }
//
//    public List<GroundPredicate> createGroundPredicates(MLN mln, Map<String, Set<Integer>> varTypeToDomain) {
